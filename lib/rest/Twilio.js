 ...
 * @property {Twilio.Notifications} notifications - notifications domain
 ...
 * @param {HttpClient} [opts.httpClient] - The client used for http requests
 ...
 * @param {string} [opts.region] - Region to make request
 *
...
Object.defineProperty(Twilio.prototype,
  'notifications', {
  get: function() {
    this._notifications = this._notifications || new Notifications(this);
